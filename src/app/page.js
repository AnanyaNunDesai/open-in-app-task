    ...
    <main>
      ...
      <div className="flex flex-row justify-around min-h-screen">
        ...
        <div className="flex flex-col justify-around items-stretch">
          ...
          <h1 className="font-montserrat font-bold text-white self-center text-7xl mt-52">
            Board.
          </h1>
          {/*TODO: Update these placeholders with the proper icons*/}
          <div className="flex flex-row self-center text-white justify-around gap-x-5 mb-[67px]">
            <svg
          ...
          <div className="flex flex-col">
            <div className="border rounded-2xl border-transparent p-5 bg-white justify-center">
              <div className="mb-4">
                ...
                <label htmlFor="email" className="font-lato leading-7 text-base text-black">Email address
                </label>
                <input
                  type="email"
                  id="email"
                  name="email"
                  className="font-lato text-base w-full bg-[#F5F5F5] rounded focus:bg-[#EAEAEA] text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
              </div>
              <div className="mb-4">
            ...
            <div className="flex flex-row gap-x-1 justify-center mt-4">
              <p className="font-lato text-xs text-secondary">Don't have an account?</p>
              <p className="font-lato text-xs text-link">Register here</p>
            </div>
          </div>
        </div>
      </div>
