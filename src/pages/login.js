        ...
        <div id="hello" className="flex flex-row justify-around min-h-screen">
          <div className="flex flex-col justify-around items-stretch">
            ...
            <div className="relative top-60 flex flex-row self-center text-white justify-around space-x-10 mt-40 mb-[50px]">
              ...
              >
                <svg
                  className="h-[25px] w-[25px] mt-[5px]" // This sets the width and height consistently with the other icons
                  fill="currentColor"
          ...
          <div className="flex flex-col justify-center gap-y-3">
            ...
            <p className="font-lato font-normal text-base self-start">
            ...
            <div className="flex flex-col">
              <div className="border rounded-2xl border-transparent p-5 bg-white justify-center">
                <div className="mb-4">
                  <label
                    htmlFor="email"
                    className="font-lato leading-7 text-base text-black mb-2"
                  >
                    Email address
                  </label>
                  <input
                ...
                <div className="mb-4">
                  <label
                    htmlFor="password"
                    className="font-lato leading-7 text-base text-black"
                  >
                    Password
                  </label>
                  <input
                ...
                <p className="mb-4 font-lato text-sm text-link">
                  Forgot password?
                </p>
                <Link href="/dashboard">
              ...
              <div className="flex flex-row gap-x-1 justify-center mt-4">
                <p className="font-lato text-xs font-base text-secondary">
                  Don't have an account?
                </p>
                <p className="font-lato text-xs font-base text-link">
                  Register here
                </p>
              </div>
            </div>
